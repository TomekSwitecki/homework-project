...
function Button(props) {
  ...
  if(props.linkTo)
  {
    return (
      <div className={`${[`expander__${props.size}`]}`}>
        ...
        {props.icon!=null ? <img className={buttons.button_icon_prepend} src={props.icon}  alt="icon"></img> : null}
  ...
  else
  {
    return (
      <div className={`${[`expander__${props.size}`]}`}>
        <div className={buttons.button_container}>
        {props.icon!=null ? <img  className={buttons.button_icon_prepend} src={props.icon}  alt="button_icon"></img> : null}
        <button type={props.type} className={`${buttons.btn_wrapper} ${buttons[`btn_${props.color}`]}`} onClick={props.onClick}>
            {props.text}
        </button>
        </div>
